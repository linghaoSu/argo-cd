...
import {IgnoreDifferencesPanel} from './ignore-differences-panel';
                ...
                return (
                    <div className='application-resources-diff'>
                        <div className={whiteBox + ' application-resources-diff__checkboxes'}>
                            ...
                            {props.application && (
                                <button className='argo-button argo-button--base-o' style={{marginLeft: '1em'}} onClick={() => setShowIgnoreEditor(true)}>
                        ...
                        {props.application && (
                            <IgnoreDifferencesPanel application={props.application} states={props.states} shown={showIgnoreEditor} onClose={() => setShowIgnoreEditor(false)} />
                        )}
                    </div>
                );
            }}
